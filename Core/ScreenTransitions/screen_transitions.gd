...
func _create_fade_scene(fade_out: bool, onexit: Callable) -> FadeScene:
...
func fade(next_scene: Node):
	...
	var fade_out_exit = func():
		var fade_in_scene = _create_fade_scene(false, fade_in_exit)
	...
	var fade_out_scene = _create_fade_scene(true, fade_out_exit)
